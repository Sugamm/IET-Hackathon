...
<?php
$selectQueryView="SELECT * FROM bucketPost order by post_id DESC";
		...
		<div class="card">
			<a href="view.php?pi='.$rowView['post_id'].'">
				<div class="card-content">
				 <div class="row" style="margin-bottom: -10px">
				 	<div class="col s6 m8">
				 		 <img src="images/'.$rowUser['profilePic'].'" style="width: 10%;">
				 		 <span style="position: absolute;top: 14px;left: 80px;">'.$rowUser['userName'].'<br><small style="padding-top:-1px;">'.$rowView['bucket_name'].'</small>
				 		 </span>
				 	</div>
	            ...
	            <div class="card-image">
	              <img src="uploads/'.$rowView['post_image'].'" style="height: 300px;">
	              <span class="card-title" style="background: rgba(16, 16, 16, 0.75);">'.$rowView['post_title'].'</span>
	            </div>
	            <div class="card-content">
	        ...
	        <div class="card-content">
	         <hr style="margin:-20px 0 10px 0;">
	          	...
	          	<i class="material-icons" style="padding:0px 0;">queue_play_next</i> <span style="position: absolute;left: 55px;bottom:26px;">Url : <span class="copyUrl" >http://hostellife.co/user/view.php?pi='.$rowView['post_id'].'</span></span>
	          	<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A//localhost/iet/user/view.php?pi='.$rowView['post_id'].'"><img src="images/facebook.png" style="padding:10px;width: 7%;float: right;"></a>
	          	<a target="_blank" href="https://twitter.com/home?status=http%3A//localhost/iet/user/view.php?pi=1"><img src="images/twitter.png" style="padding:10px;width: 7%;float: right;"></a>
	          	<a target="_blank" href="https://plus.google.com/share?url=http://localhost/iet/user/view.php?pi='.$rowView['post_id'].'" onclick="javascript:window.open(this.href,"", "menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600");return false;"><img src="images/googleplus.png" style="padding:10px;width: 7%;float: right;"></a>
